 ...
 * pass either shape.
 */
function fileLookupKeys(fileArg, absPath, repoRoot) {
 ...
 */
function findDirectEntries(entries, filesIndex, lookupKeys) {
    const ids = new Set();
 ...
 */
function findRelatedEntries(entries, directModules) {
    return entries.filter((e) => !directModules.has(e.module) &&
...
export function register(program) {
    program
        ...
        const direct = findDirectEntries(allEntries, filesIndex, fileLookupKeys(file, absPath, repoRoot));
